...
export function ContactBanner() {
  ...
  return (
    <section className="py-16 md:py-20 bg-accent-soft/50 border-t border-border/80 select-none">
      <div className="container mx-auto px-4 md:px-6 text-center max-w-3xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-zalo hover:brightness-105 text-white font-bold py-3.5 px-8 rounded-pill shadow-md hover:shadow-lg transition-all"
          >
          ...
          <a
            href={`tel:${cleanPhone}`}
            className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-primary hover:bg-primary-hover text-white font-semibold py-3.5 px-8 rounded-pill shadow-md hover:shadow-lg transition-all"
          >
